...
part of 'job_posting_update_request.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

JobPostingUpdateRequest _$JobPostingUpdateRequestFromJson(
  ...
  status: $enumDecode(_$JobPostingStatusEnumMap, json['status']),
  skillIds: (json['skillIds'] as List<dynamic>?)
      ?.map((e) => (e as num).toInt())
      .toList(),
);

Map<String, dynamic> _$JobPostingUpdateRequestToJson(
  JobPostingUpdateRequest instance,
) => <String, dynamic>{
